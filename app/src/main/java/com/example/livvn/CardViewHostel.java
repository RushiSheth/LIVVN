...
public class CardViewHostel extends AppCompatActivity implements View.OnClickListener {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_card_view_hostel);
    ...
    private void setImage(String imageUrl, String name_text, String infor, String rating) {
        ...
        TextView name = findViewById(R.id.card_hosname);
        name.setText(name_text);
        TextView info = findViewById(R.id.card_hosinfo);
        info.setText(infor);
        TextView rate = findViewById(R.id.card_hosrating);
        rate.setText(rating);
        ImageView image = findViewById(R.id.card_hosimage);
        Glide.with(this)
                .asBitmap()
                .load(imageUrl)
                .into(image);
    ...
    public void passmap() {
        Intent intent = new Intent(CardViewHostel.this, Map.class);
